...
**Because the first factor level is plotted where the 1 would be on the y-axis, the second level is plotted where the 2 would be, etc.  So the first level is at the bottom of the plot.**
```{r}
